...
mkdir /workspaces/dataset/repositories/developer-informed-oracle/1token_github.com

cp -r /workspaces/dataset/repositories/developer-informed-oracle/github.com/* /workspaces/dataset/repositories/developer-informed-oracle/1token_github.com/

REPO_BASE="/workspaces/dataset/repositories/developer-informed-oracle/1token_github.com"
...
function wrap_cregit() {
    ...
    mkdir -p /workspaces/dataset/pyszz_v2/cloned/developer-informed-oracle/original/"$owner"/
    mkdir -p /workspaces/dataset/pyszz_v2/cloned/developer-informed-oracle/1token/"$owner"/

    cp -r "$repo_original" "/workspaces/dataset/pyszz_v2/cloned/developer-informed-oracle/original/$owner/$repo"
    cp -r "$repo_cregit" "/workspaces/dataset/pyszz_v2/cloned/developer-informed-oracle/1token/$owner/$repo"

    mkdir -p /workspaces/dataset/databases/developer-informed-oracle/1token/"$owner"/"$repo"
    cp -r "$repo_cregit.db" "/workspaces/dataset/databases/developer-informed-oracle/1token/$owner/$repo/"
...
rm -rf /workspaces/dataset/repositories/developer-informed-oracle/1token_github.com
